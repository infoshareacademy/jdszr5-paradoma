...
* [kickstarter.com](https://www.kickstarter.com/blog/shortening-the-maximum-project-length/)""")
    ...
    if selected_amount < amount_list[0]:
        money_y = 0
        money_x = round(amount_list[0], 0)
    elif selected_amount >= amount_list[0] and selected_amount < amount_list[1]:
        money_y = round(amount_list[0], 0)
        money_x = round(amount_list[1], 0)
    elif selected_amount >= amount_list[1] and selected_amount < amount_list[2]:
        money_y = round(amount_list[1], 0)
        money_x = round(amount_list[2], 0)
    elif selected_amount >= amount_list[2] and selected_amount < amount_list[3]:
        money_y = round(amount_list[2], 0)
        money_x = round(amount_list[3], 0)  
    elif selected_amount >= amount_list[3]:
        money_y = round(amount_list[3], 0)
        money_x = 25000000 
    ...
    money_ranges= [(0,round(amount_list[0],0)),(round(amount_list[0],0),round(amount_list[1],0)),(round(amount_list[1],0),round(amount_list[2],0)), (round(amount_list[2],0),round(amount_list[3],0)),(round(amount_list[3],0),25000000) ]
    better_m = 0
    list_money_graph_x = []
    list_money_graph_y =[]
